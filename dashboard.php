...
if(isset($_POST['Generate'])) {
   ...
   $resultcount=mysqli_query($conn,$querycountsubtask);
   ...
   $resultcount1=mysqli_query($conn,$querycounttask);
                                            ...
                                            <div class="col-md-12">
                                                <form method="POST" action="dashboard.php">
                                                    <div class="row">
                                                        ...
                                                        <div id="circlechart1" class="circlechart1"
                                                            data-percentage=<?=intval($finalprojectcount);?>>
                                                            <?=$projectname;?></div>
                                                        <br>
                                                    </div>
                                                    <script>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="circlechart2"
                                                        data-percentage=<?=intval($finaltaskcount);?>><?=$taskname;?>
                                                    </div>
                                                    <br>
                                                </div>
                                                <script>
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    <div class="circlechart3" data-percentage=<?=$subtaskperc?>>
                                                        <?=$subtaskname?></div>
                                                    <br>
                                                </div>
                                                <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <center>
                                                            <input class="btn btn-danger btn-circle btn-xl"
                                                                type="submit" value="Generate" name="Generate">
                                                        </center>
                                                    </div>
                                                    <br>
                                                    <br>
